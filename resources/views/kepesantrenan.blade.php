...
<head>
    ...
    <meta name="description" content="Galeri Kepesantrenan Madrasah Assalaam menampilkan momen-momen berharga dalam kegiatan pesantren, termasuk pembinaan keislaman dan kehidupan sehari-hari santri.">
    <meta name="keywords" content="galeri kepesantrenan, kegiatan pesantren, madrasah Assalaam, santri, kehidupan pesantren, pendidikan Islam">
...
<body>
    ...
    <h2 class="text-center mb-5 mt-5">Galeri Kegiatan Kepesantrenan</h2>

    <div class="api-container mb-5">
        @foreach ($videos as $index => $video)
            <input type="radio" name="slider" id="item-{{ $index + 1 }}" target="blank" {{ $index === 0 ? 'checked' : '' }}>
        @endforeach
    ...
    <div class="galeri-container">
        <div class="row g-4 mb-3">
            @foreach ($kepesantrenanFoto as $data)
