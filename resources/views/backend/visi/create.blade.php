...
@section('content')
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form action="{{ route('backend.visi.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="mb-3 row">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-md-10">
                        <textarea class="form-control @error('isi') is-invalid @enderror" id="text-isi" rows="15" name="isi"></textarea>
                        @error('isi')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
...
@push('scripts')
    ...
    <script type="module">
        ...
        ClassicEditor
            .create(document.querySelector('#text-isi'), {
