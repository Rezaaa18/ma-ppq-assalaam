...
@section('navbar')
    <nav class="layout-navbar container-xxl navbar navbar-expand-xl navbar-detached align-items-center bg-navbar-theme"
        ...
        <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
            <!-- Search -->
            <form method="GET" action="{{ route('backend.kategori-fasilitas.index') }}"
                ...
                <div class="nav-item d-flex align-items-center">
                    ...
                    <input type="text" name="search" class="form-control border-0 shadow-none"
                        placeholder="Cari kategori Fasilitas..." aria-label="Search..."
...
@section('content')
    <div class="card">
        <div class="card-header">
            <div class="row">
                <div class="col">
                    <h5>Kategori Fasilitas</h5>
                </div>
                <div class="col">
                    <button type="button" class="btn rounded-pill btn-success float-end" data-bs-toggle="modal"
                        data-bs-target="#backDropModal"><i class='bx bxs-add-to-queue'></i> Tambah Kategori
                        Fasilitas</button>
                    <!-- Modal Store -->
                    <div class="modal fade" id="backDropModal" data-bs-backdrop="static" tabindex="-1">
                        <div class="modal-dialog modal-dialog-centered">
                            <form class="modal-content" action="{{ route('backend.kategori-fasilitas.store') }}"
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        <div class="col mb-3">
                                            <label for="nameBackdrop" class="form-label">Kategori Fasilitas</label>
                                            <input type="text" id="nameBackdrop"
                                                class="form-control @error('nama_kategori') is-invalid @enderror"
                                                placeholder="masukan kategori fasilitas" name="nama_kategori" />
                                            @error('nama_kategori')
                        ...
                        @foreach ($fasilitas as $data)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="modal fade" id="updateModal{{ $data->id }}" data-bs-backdrop="static"
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <form class="modal-content"
                                                action="{{ route('backend.kategori-fasilitas.update', $data->id) }}"
                                                method="POST" enctype="multipart/form-data">
                                                @csrf
                                                @method('PUT')
                                                <div class="modal-header">
                                                ...
                                                <div class="modal-body">
                                                    <div class="row">
                                                        <div class="col mb-3">
                                                            <label for="nameBackdrop" class="form-label">Kategori
                                                                Fasilitas</label>
                                                            <input type="text" id="nameBackdrop"
                                                                class="form-control @error('nama_kategori') is-invalid @enderror"
                                    ...
                                    <a href="{{ route('backend.kategori-fasilitas.destroy', $data->id) }}" type="button"
